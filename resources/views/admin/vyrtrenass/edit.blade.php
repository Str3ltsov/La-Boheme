        ...
        <div class="d-flex flex-column justify-content-start pl-20 pr-20 pr-lg-0 pl-lg-0" style="min-height: 100%; padding: 0">
            <div class="d-flex flex-column justify-content-center align-items-center bg-transparent" id="cormorant">
                <div class="d-flex flex-column justify-content-center align-items-center my-3 text-light" style="font-size: 1.1em; width: 100%">
                    ...
                    {!! Form::model($assistant, ['route' => ['vyrtrenasss.update', $assistant->id], 'method' => 'patch', 'class' => 'mt-20', 'enctype' => "multipart/form-data", 'files' => true]) !!}
                    <div class="row">
                        <div class="form-groum col-sm-4 col-xs-12 mb-xs-20">
                            <input type="text" name="first_name" class="form-control"
                                   style="border-radius: 5px;" placeholder="{{ __('First name *') }}" value="{{ $assistant->first_name }}">
                            @error('first_name')
                        ...
                        <div class="form-group col-sm-4 col-xs-12">
                            <input type="text" name="last_name" class="form-control"
                                   style="border-radius: 5px;" placeholder="{{ __('Last name *') }}" value="{{ $assistant->last_name }}">
                            @error('last_name')
                                <span class="text-danger mt-1 fs-5 fade-in">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="reservation_type_id" value="{{ $assistant->reservation_type_id }}">
                        </div>
                    </div>
