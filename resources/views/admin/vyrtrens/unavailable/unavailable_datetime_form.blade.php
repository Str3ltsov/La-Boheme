{!! Form::open([
    'route' => ['admin.vyrtrens.createUnavailableDateTime', $coach->id],
    'method' => 'post'
    ]) !!}
    <input type="hidden" name="vyrtren_id" value="{{ $coach->id }}">
    <div class="w-100 d-flex align-items-center my-3">
        <label for="unavailable_date" class="form-label w-25">{{ __('Date time') }}:</label>
        <input
