...
@section('content')
    <div>
        ...
        <div class="d-flex flex-column justify-content-start" style="background-color: #1B3253; min-height: 65vh; padding: 0 2em">
            <div class="d-flex flex-column justify-content-center align-items-center bg-transparent p-4" id="cormorant">
                <div class="d-flex flex-column justify-content-center align-items-center mb-5 fs-5 text-light" style="font-size: 1.1em; width: clamp(300px, 100%, 600px)">
                    <div class="w-100">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center my-3 fs-4 w-100">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <input id="email" type="email" class="form-control fs-4 text-light bg-transparent
                                           ...
                                           style="border-radius: 5px; border-color: #C19F5F" required autocomplete="email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <input id="password" type="password" class="form-control fs-4 text-light bg-transparent
                                           ...
                                           style="border-radius: 5px; border-color: #C19F5F" name="password" required autocomplete="new-password">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <input id="password-confirm" type="password" class="form-control fs-4 text-light bg-transparent" name="password_confirmation" required autocomplete="new-password"
                                           style="border-radius: 5px; border-color: #C19F5F">
                                </div>
                            </div>
                            <div class="d-flex justify-content-center align-items-center mt-5">
                                <div>
                                    <button type="submit" class="fw-bold fs-3" style="background-color: #D3152E; border: none; border-radius: 5px; color: white; padding: 10px; width: 170px;">
                                        {{ __('Registruotis') }}
                                    </button>
                                </div>
                            </div>
