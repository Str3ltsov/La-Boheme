                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <input id="email" type="email" class="form-control fs-4 text-light bg-transparent
                                           ...
                                           name="email" value="{{ old('email') }}" required autocomplete="email" autofocus style="border-radius: 5px; border-color: #C19F5F">
                                    @error('email')
                            ...
                            <div class="row mt-5">
                                <div class="d-flex flex-column justify-content-center align-items-center" style="gap: 15px">
                                    <button type="submit" class="fw-bold fs-4" style="background-color: #D3152E; border: none; border-radius: 5px; color: white; padding: 10px 0; width: 100%">
