...
<div>
    ...
    <p>&nbsp;</p>
    <p>Rezervuodami <a class="0" download="0" href="https://rezervuok.recovcenter.com" rel="noopener noreferrer nofollow" target="_blank" title="0">https://rezervuok.recovcenter.com</a> svetainėje Jūs patikite MB "Du prieš du" (toliau - Bendrovė, arba mes) savo asmens duomenis ir suteikiate mums teisę juos tvarkyti šioje Politikoje (toliau - Politika) numatyta apimtimi, būdais ir tikslais. Savo duomenis Jūs taip pat pateikiate teikdami mums savo atsiliepimus.</p>
    <p><strong>Jeigu Jūs nesutinkate su šia Politika ar atskiromis jų sąlygomis, mes, deja, negalėsime suteikti Jums galimybės naudotis visomis ar bet kuria i&scaron; Bendrovės teikiamų paslaugų (toliau &ndash; Paslaugos)</strong>.</p>
    <p>Šioje Politikoje Jūs rasite visą informaciją, kokius Jūsų duomenis mes renkame ir tvarkome, kam juos naudojame, kiek laiko saugome ir kt. &Scaron;i informacija svarbi, todėl tikimės, kad atidžiai ją perskaitysite.</p>
    ...
    <p><strong>Bendrovė renka ir tvarko šioje Politikoje i&scaron;vardintus Jūsų asmens duomenis šiais teisiniais pagrindais:</strong></p>
    <p>&ndash; Jūsų sutikimas su šioje Politikoje numatytomis sąlygomis;</p>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="1" rowspan="1">
                <p>Jūsų sutikimas naudotis paskyra Politikoje numatytomis sąlygomis</p>
            </td>
        </tr>
        <tr>
            <td colspan="1" rowspan="1">
    ...
    <p>Jūsų duomenis mes naudojame tik tam, kad galėtume tinkamai ir objektyviai išnagrinėti Jūsų Užklausą, suteikti Jums reikiamą informaciją, atsakyti į Jūsų klausimus, išspręsti Jūsų prašymus ar reikalavimus. Užklausos duomenis mes taip pat galime analizuoti siekdami gerinti mūsų veiklos ir Jums teikiamų paslaugų kokybę, atsižvelgiant į Jūsų nuomonę bei pasiūlymus.</p>
    <p>Jūsų Užklausą ir su ja susijusius Jūsų duomenis mes tvarkome ir saugome tol, kol i&scaron;nagrinėjame Užklausą, pateikiame Jums atsakymą ir įvykdome priimtus sprendimus, o taip pat dar iki 6 (šešių) mėnesių po Užklausos i&scaron;sprendimo.</p>
    <p>Jeigu dėl Užklausos inicijuojamas teisinis ginčas arba yra tokio ginčo tikimybė, mes Jūsų duomenis galime saugoti ilgiau, iki pasibaigs teisės aktuose numatyti skundo pateikimo ar ieškinio senaties terminai ir (arba) įsiteisės galutinis sprendimas.</p>
    <p>Pasibaigus šioje Politikoje nustatytam Jūsų duomenų tvarkymo ir saugojimo terminui, mes Jūsų duomenis sunaikinsime.</p>
    <p><strong>Iš kokių šaltinių mes renkame Jūsų asmens duomenis?</strong></p>
    <p>Beveik visus Jūsų asmens duomenis mes gauname tik iš Jūsų. Anketinius duomenis Jūs mums pateikiate tiesiogiai, pvz., pildydamas registracijos anketas.</p>
    <p>Jūsų duomenis mes taip pat gauname tiesiogiai iš Jūsų, kai Jūs pateikiate Užklausą bet kuriuo iš Jūsų pasirinktų būdų: parašydami mums elektroninį lai&scaron;ką, pateikdami mums ra&scaron;ytinę užklausą, skambindami į mūsų klientų nusiskundimo telefoną.</p>
    <p>Jeigu siekiant kokybiškai ir objektyviai išnagrinėti Jūsų Užklausą mums reikia surinkti papildomą informaciją ar atlikti reikšmingų aplinkybių tyrimą, mes Jūsų Užklausos duomenis galime susieti su mūsų turimais ir (ar) nagrinėjant Jūsų Užklausą surinktais duomenimis, pvz. pirkimo operacijų duomenis, apklausti mūsų darbuotojus ir pan.</p>
    ...
    <p>Didžiąją dalį šios informacijos mes pateikiame Jums šioje Politikoje ir tikime, kad ji yra Jums naudinga.</p>
    <p><strong>Teisė ištaisyti asmens duomenis</strong></p>
    <p>Jeigu pasikeitė Jūsų kandidatavimo anketoje mums pateikti duomenys arba Jūs manote, kad mūsų tvarkoma informacija apie Jus yra netiksli ar neteisinga, Jūs turite teisę reikalauti šią informaciją pakeisti, patikslinti ar ištaisyti.</p>
    <p><strong>Teisė atšaukti sutikimą</strong></p>
    <p>Tais atvejais, kai Jūsų duomenis mes tvarkome Jūsų sutikimo pagrindu, Jūs turite teisę bet kada atšaukti savo sutikimą ir Jūsų sutikimu grindžiamas duomenų tvarkymas bus nutrauktas.</p>
    <p>Nustojus galioti Jūsų sutikimui, jį at&scaron;aukus arba panaikinus, mes Jūsų sutikimu tvarkytus duomenis sunaikiname.</p>
    <p>Bet kokiu atveju Jūsų suteiktą sutikimą ir įrodymą apie jį mes galime saugoti ir ilgesnį laikotarpį, jei to reikia, kad galėtume apsiginti nuo mums pareikštų reikalavimų, pretenzijų ar ie&scaron;kinių.</p>
    <p><strong>Teisė pateikti skundą</strong></p>
    <p>Jeigu Jūs manote, kad Jūsų duomenis mes tvarkome pažeisdami duomenų apsaugos teisės aktų reikalavimus, mes visuomet pirmiausia prašome kreiptis tiesiogiai į mus. Mes tikime, kad geranori&scaron;komis pastangomis mums pavyks i&scaron;sklaidyti visas Jūsų abejones, patenkinti prašymus ir i&scaron;taisyti mūsų padarytas klaidas, jeigu tokių bus.</p>
    <p>Jeigu Jūsų netenkins mūsų siūlomas problemos išsprendimo būdas arba, Jūsų nuomone, mes nesiimsime pagal Jūsų pra&scaron;ymą būtinų veiksmų, Jūs turėsite teisę pateikti skundą priežiūros institucijai, kuria Lietuvos Respublikoje yra Valstybinė duomenų apsaugos inspekcija.</p>
    ...
    <p><strong>Teisė ištrinti duomenis (teisė būti pamirštam)</strong></p>
    <p>Esant tam tikroms duomenų tvarkymo teisės aktuose įvardintoms aplinkybėms (kai asmens duomenys tvarkomi neteisėtai, i&scaron;nyko duomenų tvarkymo pagrindas ir kt.), Jūs turite teisę pra&scaron;yti, kad mes i&scaron;trintume Jūsų asmens duomenis. Norėdami pasinaudoti šia teise, pra&scaron;om pateikti ra&scaron;ti&scaron;ką pra&scaron;ymą mūsų Bendrovei.</p>
    <p>Svarbu pažymėti, kad Jūsų duomenys be Jūsų atskiro prašymo bus ištrinti.</p>
    ...
    <p>Norėdami pasinaudoti &scaron;iame skirsnyje nurodyta teise, prašom pateikti raštišką pra&scaron;ymą mūsų Bendrovei.</p>
    <p><strong>Prašymų nagrinėjimo tvarka</strong></p>
    <p>Siekdami apsaugoti visų savo mūsų kandidatų ir pirkėjų duomenis nuo neteisėto atskleidimo, mes, gavę Jūsų prašymą pateikti duomenis ar įgyvendinti kitas Jūsų teises, privalėsime nustatyti Jūsų tapatybę. Šiuo tikslu mes galime prašyti Jus nurodyti Jūsų pateiktus aktualius anketinius duomenis (pvz., vardą, el. pa&scaron;to adresą ar tel. numerį) ir lyginsime, ar Jūsų nurodyti duomenys sutampa su atitinkamais anketiniais duomenimis. Vykdydami šį patikrinimą, mes taip pat galime i&scaron;siųsti kontrolinį prane&scaron;imą registracijos anketoje nurodytu kontaktu (SMS arba el. paštu), pra&scaron;ydami atlikti autorizacijos veiksmą. Jeigu patikrinimo procedūra bus nesėkminga (pvz., Jūsų nurodytieji anketiniai duomenys nesutaps su anketoje nurodytais duomenimis arba Jūs nesiautorizuosite pagal gautą SMS ar el. pa&scaron;to prane&scaron;imą), mes būsime priversti konstatuoti, kad Jūs nesate pra&scaron;omų duomenų subjektas ir privalėsime atmesti Jūsų pateiktą pra&scaron;ymą.</p>
    <p>Gavę Jūsų prašymą dėl bet kurios Jūsų teisės įgyvendinimo ir sėkmingai atlikę aukščiau nurodytą patikrinimo procedūrą, mes įsipareigojame nepagrįstai nedelsdami, tačiau bet kuriuo atveju ne vėliau kaip per vieną mėnesį nuo Jūsų prašymo gavimo ir patikrinimo procedūros užbaigimo, pateikti Jums informaciją apie veiksmus, kurių ėmėmės pagal Jūsų pateiktą pra&scaron;ymą. Atsižvelgdami į pra&scaron;ymų sudėtingumą ir skaičių, mes turime teisę vieno mėnesio laikotarpį pratęsti dar dviem mėnesiams, apie tai Jus informuodami iki pirmojo mėnesio pabaigos ir nurodydami tokio pratęsimo priežastis.</p>
    <p>Jeigu Jūsų prašymas pateikiamas elektroninėmis priemonėmis, atsakymą mes Jums taip pat pateiksime elektroninėmis priemonėmis, išskyrus atvejus, kai tai bus neįmanoma (pvz., dėl itin didelės informacijos apimties) arba tuomet, jei Jūs pra&scaron;ysite Jums atsakyti kitu būdu.</p>
    ...
    <p>Mes naudojame įvairias saugumą užtikrinančias technologijas ir procedūras, siekdami apsaugoti Jūsų asmeninę informaciją nuo neteisėtos prieigos, naudojimo ar atskleidimo. Mūsų tiekėjai yra kruopščiai atrenkami, mes i&scaron; jų reikalaujame naudoti tinkamas priemones, galinčias apsaugoti Jūsų konfidencialumą ir užtikrinti Jūsų asmeninės informacijos saugumą. Visgi, informacijos perdavimo internetu ar mobiliuoju ryšiu saugumas negali būti užtikrintas; bet koks informacijos mums perdavimas nurodytais būdais yra vykdomas Jūsų pačių rizika.</p>
    <p><strong>Ilgesnis duomenų saugojimas</strong></p>
    <p>Pasibaigus šioje Politikoje nustatytam Jūsų duomenų tvarkymo ir saugojimo terminui, mes Jūsų duomenis sunaikiname.</p>
    <p>Ilgesnis, negu specialiai nurodyta šioje Politikoje, Jūsų asmens duomenų saugojimas gali būti vykdomas tik, kai:</p>
