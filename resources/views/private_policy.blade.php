    ...
    <div>
        ...
        <div class="d-flex flex-column justify-content-start"
            ...
            align-items-center bg-transparent p-4" id="cormorant">
                ...
                my-3 mb-5 p-5 fs-5 text-light" style="font-size: 1.1em; background-color: #151515; max-width: 1200px">
                    <div class="w-100">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start my-3 fs-5">
                        <div class="d-flex flex-column" style="gap: 10px;">
                            ...
                            <p>elektroniniu pa&scaron;tu info@laboheme.lt</p>

                            <p>pa&scaron;to korespondencijos adresas &ndash; &Scaron;v. Ignoto g. 4, 01144 Vilnius</p>

                            <p><em>Lai&scaron;ką adresuokite taip: UAB &bdquo;Pramogų pilis&ldquo;, Duomenų apsaugos pareigūnui</em>.</p>

                            <p>Mūsų, kaip duomenų valdytojo, rekvizitai:</p>

                            <p>UAB &bdquo;Pramogų pilis&ldquo;</p>

                            <p>Juridinio asmens kodas 300648313</p>

                            <p>Buveinės adresas: &Scaron;v. Ignoto g. 4, 01144 Vilnius</p>
                            ...
                            <p>&Scaron;i Politika galioja nuo 2022 m. rugpjūčio 2 d. Jei pakeisime &scaron;ią Politiką, paskelbsime jos atnaujintą versiją &scaron;iame puslapyje.</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center align-items-center w-100 mt-4" style="gap: 20px;">
                        <button type="button" class="fw-bold fs-4 btn-hover-focus"
                                onclick="window.location.href = `{{ route('livewire.reservation')}}`"
